...
# files = os.listdir('C:\\Users\\Yana\\project\\corpus_slice_conllu')
# for f_name in files:
#     path = 'C:\\Users\\Yana\\project\\corpus_slice_conllu\\' + f_name
#     print(f_name)
#     with open(path, 'r', encoding='utf-8') as f:
#         text = f.read()
#     new_text = convert_to_basic(text)
#     output_path = 'C:\\Users\\Yana\\project\\corpus_slice_conllu_basic\\' + f_name
